package com.ashmit.ecommerce.customer;

import com.ashmit.ecommerce.exception.CustomerNotFoundException;
...
public class CustomerService {
    ...
    public CustomerResponse findById(String customerId) {
        return repository.findById(customerId).map(mapper :: fromCustomer).orElseThrow(() ->
                new CustomerNotFoundException(String.format("No customer found with provide ID :: %s",customerId)));
    }
